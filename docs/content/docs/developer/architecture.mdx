...
SQLite database
    ...
    |        |
    |        v
    |    Embeddings (384D vectors, sqlite-vec)
    |
...
**sqlite-vec**: Vector search uses the [sqlite-vec](https://github.com/asg017/sqlite-vec) extension for in-process embedding similarity search. No external vector database.
